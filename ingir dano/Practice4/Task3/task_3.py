...
def load_file_1(file_name1):
    with open('task_3_var_56_part_1.msgpack', 'rb') as file:
...
def load_file_2(file_name2):
    with open('task_3_var_56_part_2.pkl', 'rb') as f:
        data = pickle.load(f)
...
general_items = load_file_1("task_3_var_56_part_1.msgpack") + load_file_2("task_3_var_21_part_2.pkl")
